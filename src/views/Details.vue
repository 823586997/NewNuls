   ...
   <div class="details">
      <div class='nodeInfo_cen'>
         <div class='nickname'>
               <p>
                  <span class='avatar'>
                     <img :src=" data.avatar ? data.avatar : require('../static/images/default.jpg') " alt="">
                  </span>
               </p>
               <span>
                  <i v-if=" data.id == nodeId && data.checkstatus == '0' " class='buldGreen'></i>
                  <i v-if=" data.id == nodeId && data.checkstatus == '2' " class='buldRed'></i>
                  <i v-if=" data.id == nodeId && data.checkstatus == '1' " class='buldYellow'></i>
                  <i v-if=" role == 'admin' && data.checkstatus == '1' " class='yes' @click='judgeYes()'></i>
                  <i v-if=" role == 'admin' && data.checkstatus == '1' " class='no' @click='judgeNo()'></i>
                  <i v-if=" role == 'admin' || data.id == nodeId " class='redact' @click='Change()'></i>
               </span>
         </div>
         <div class='message'>
               <div class='one'>
